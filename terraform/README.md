...
```
curl "https://nubesgen.com/demo.tgz?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.standard&runtime=SPRING&database=POSTGRESQL.basic&addons=key_vault&gitops=true&network=VIRTUAL_NETWORK" | tar -xzvf -
```
