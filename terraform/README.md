...
```
curl "http://localhost:8080/demo.tgz?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.basic&runtime=SPRING&database=POSTGRESQL.basic&addons=key_vault&gitops=true" | tar -xzvf -
```
