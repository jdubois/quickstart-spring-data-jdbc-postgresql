...
```
curl "http://localhost:8080/quicksta-9141-7766.zip?region=westeurope&application=APP_SERVICE.standard&runtime=SPRING&database=POSTGRESQL&addons=key_vault&gitops=true" | tar -xzvf -
```
